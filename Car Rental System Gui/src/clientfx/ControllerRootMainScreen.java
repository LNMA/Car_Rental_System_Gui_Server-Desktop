...
public class ControllerRootMainScreen {
    ...
    static Stage addCarStage = new Stage();
    static Stage showAllCarStage = new Stage();
    static Stage AddAccountStage = new Stage();
    static Stage showAllAccountStage = new Stage();
    static Stage showOrderByCarIDStage = new Stage();
    static Stage showAllOrderStage = new Stage();
    ...
    public Tab editSupervisorSectionTab;
    public Tab editSupervisorRankTab;
    public Tab editAccountTypeTab;
    ...
    public TextField editAccountTypeUsernameTxt;
    public ComboBox editAccountTypeComboBox;
    public Label editAccountTypeLabel;
    public TextField editSupervisorRankUsernameTxt;
    public TextField editSupervisorRankTxt;
    public Label editSupervisorRankLabel;
    public TextField editSupervisorSectionUsernameTxt;
    public TextField editSupervisorSectionTxt;
    public Label editSupervisorSectionLabel;
    ...
    public Tab serverPortTab;
    public Tab clientPortTab;
    public Tab dbUrlTab;
    public Tab dbUserTab;
    public Tab dbPasswordTab;
    public Tab serverHostTab;
    public Label serverPortLabel;
    public TextField serverPortTxt;
    public Label clientPortLabel;
    public TextField clientPortTxt;
    public Label dbUrlLabel;
    public TextField dbUrlTxt;
    public Label dbUserLabel;
    public TextField dbUserTxt;
    public Label dbPasswordLabel;
    public TextField dbPasswordTxt;
    public Label serverHostLabel;
    public TextField serverHostTxt;
    ...
    public void showAllAccount(ActionEvent actionEvent) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("showAllAccount.fxml"));
            showAllAccountStage.setTitle("All Account");
            showAllAccountStage.setScene(new Scene(root, 800, 600));
            showAllAccountStage.show();
        }catch (Exception e){
            System.out.println(e.getMessage());
            e.printStackTrace();
        }
    ...
    public void editSupervisorSection(ActionEvent actionEvent) {
        if (editSupervisorSectionUsernameTxt.getText().isEmpty() || editSupervisorSectionTxt.getText().isEmpty()){
            editSupervisorSectionLabel.setVisible(true);
            editSupervisorSectionLabel.setText("ALL FIELD MUST FILL");
        }else {
            String username = editSupervisorSectionUsernameTxt.getText();
            String section = editSupervisorSectionTxt.getText();
            try {
                Socket socket = new Socket(SBE.getServerHost(), SBE.getClientPort());
                DataInputStream in = new DataInputStream(new BufferedInputStream(socket.getInputStream()));
                DataOutputStream out = new DataOutputStream(new BufferedOutputStream(socket.getOutputStream()));
                out.writeUTF("1ux1edit2all");
                out.writeUTF("1edit16section");
                ...
                socket.close();
                editSupervisorSectionLabel.setVisible(true);
                editSupervisorSectionLabel.setText(isExist + ". " + massage);
                editSupervisorSectionUsernameTxt.clear();
                editSupervisorSectionTxt.clear();
            } catch (Exception e) {
                System.out.println(e.getMessage());
                e.printStackTrace();
            }
    ...
    public void editSupervisorRank(ActionEvent actionEvent) {
        if (editSupervisorRankUsernameTxt.getText().isEmpty() || editSupervisorRankTxt.getText().isEmpty()){
            editSupervisorRankLabel.setVisible(true);
            editSupervisorRankLabel.setText("ALL FIELD MUST FILL");
        }else {
            String username = editSupervisorRankUsernameTxt.getText();
            String rank = editSupervisorRankTxt.getText();
            try {
                Socket socket = new Socket(SBE.getServerHost(), SBE.getClientPort());
                DataInputStream in = new DataInputStream(new BufferedInputStream(socket.getInputStream()));
                DataOutputStream out = new DataOutputStream(new BufferedOutputStream(socket.getOutputStream()));
                out.writeUTF("1ux1edit2all");
                out.writeUTF("1edit15rank");
                out.writeUTF(username);
                out.writeUTF(rank);
                out.flush();
                String isExist = in.readUTF();
                ...
                socket.close();
                editSupervisorRankLabel.setVisible(true);
                editSupervisorRankLabel.setText(isExist + ". " + massage);
                editSupervisorRankUsernameTxt.clear();
                editSupervisorRankTxt.clear();
            } catch (Exception e) {
                System.out.println(e.getMessage());
                e.printStackTrace();
            }
    ...
    public void editAccountType(ActionEvent actionEvent) {
        if (editAccountTypeUsernameTxt.getText().isEmpty() || editAccountTypeComboBox.getSelectionModel().isEmpty()){
            editAccountTypeLabel.setVisible(true);
            editAccountTypeLabel.setText("ALL FIELD MUST FILL");
        }else {
            String username = editAccountTypeUsernameTxt.getText();
            String type = (String) editAccountTypeComboBox.getSelectionModel().getSelectedItem();
            try {
                Socket socket = new Socket(SBE.getServerHost(), SBE.getClientPort());
                DataInputStream in = new DataInputStream(new BufferedInputStream(socket.getInputStream()));
                DataOutputStream out = new DataOutputStream(new BufferedOutputStream(socket.getOutputStream()));
                out.writeUTF("1ux1edit2all");
                out.writeUTF("1edit14type");
                out.writeUTF(username);
                out.writeUTF(type);
                out.flush();
                String isExist = in.readUTF();
                ...
                socket.close();
                editAccountTypeLabel.setVisible(true);
                editAccountTypeLabel.setText(isExist + ". " + massage);
                editAccountTypeUsernameTxt.clear();
                editAccountTypeComboBox.getSelectionModel().clearSelection();
            } catch (Exception e) {
                System.out.println(e.getMessage());
                e.printStackTrace();
            }
    ...
    public void showAddAccount(ActionEvent actionEvent) {
        try {
            ...
            AddAccountStage.setScene(new Scene(root, 800, 600));
    ...
    public void showEditAccountType(ActionEvent actionEvent) {
        if (!tabPane.getTabs().contains(editAccountTypeTab)) {
            tabPane.getTabs().add(editAccountTypeTab);
        }
        editAccountTypeUsernameTxt.textProperty().addListener(new ChangeListener<String>() {
            @Override
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                editAccountTypeUsernameTxt.setText(newValue.replaceAll("[\\s]+",""));
                if (editAccountTypeUsernameTxt.getText().length()>30){
                    editAccountTypeUsernameTxt.setText(editAccountTypeUsernameTxt.getText(0,30));
                }
            }
        });
    }
    ...
    public void showEditSupervisorRank(ActionEvent actionEvent) {
        if (!tabPane.getTabs().contains(editSupervisorRankTab)) {
            tabPane.getTabs().add(editSupervisorRankTab);
        }
        editSupervisorRankUsernameTxt.textProperty().addListener(new ChangeListener<String>() {
            @Override
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                editSupervisorRankUsernameTxt.setText(newValue.replaceAll("[\\s]+",""));
                if (editSupervisorRankUsernameTxt.getText().length()>30){
                    editSupervisorRankUsernameTxt.setText(editSupervisorRankUsernameTxt.getText(0,30));
                }
            }
        });
        editSupervisorRankTxt.textProperty().addListener(new ChangeListener<String>() {
            @Override
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                if (editSupervisorRankTxt.getText().length()>45){
                    editSupervisorRankTxt.setText(editSupervisorRankTxt.getText(0,45));
                }
            }
        });
    }
    ...
    public void showEditSupervisorSection(ActionEvent actionEvent) {
        if (!tabPane.getTabs().contains(editSupervisorSectionTab)) {
            tabPane.getTabs().add(editSupervisorSectionTab);
        }
        editSupervisorSectionUsernameTxt.textProperty().addListener(new ChangeListener<String>() {
            @Override
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                editSupervisorSectionUsernameTxt.setText(newValue.replaceAll("[\\s]+",""));
                if (editSupervisorSectionUsernameTxt.getText().length()>30){
                    editSupervisorSectionUsernameTxt.setText(editSupervisorSectionUsernameTxt.getText(0,30));
                }
            }
        });
        editSupervisorSectionTxt.textProperty().addListener(new ChangeListener<String>() {
            @Override
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                if (editSupervisorSectionTxt.getText().length()>45){
                    editSupervisorSectionTxt.setText(editSupervisorSectionTxt.getText(0,45));
                }
            }
        });
    }
    ...
    public void initialize(){
        ...
        tabPane.getTabs().remove(editAccountTypeTab);
        tabPane.getTabs().remove(editCustomerLicenseValidityTab);
        tabPane.getTabs().remove(editCustomerDiscountPointTab);
        tabPane.getTabs().remove(editAgeTab);
        tabPane.getTabs().remove(editSupervisorRankTab);
        tabPane.getTabs().remove(editSupervisorSectionTab);
        ...
        tabPane.getTabs().remove(serverPortTab);
        tabPane.getTabs().remove(clientPortTab);
        tabPane.getTabs().remove(dbUrlTab);
        tabPane.getTabs().remove(dbUserTab);
        tabPane.getTabs().remove(dbPasswordTab);
        tabPane.getTabs().remove(serverHostTab);
        ...
        editAccountTypeComboBox.getItems().addAll("root", "supervisor", "client");
    ...
    public void hideEditAccountTypeLabel(MouseEvent mouseEvent) {
        editAccountTypeLabel.setVisible(false);
    }


    public void hideEditSupervisorRankLabel(MouseEvent mouseEvent) {
        editSupervisorRankLabel.setVisible(false);
    }


    public void hideEditSupervisorSectionLabel(MouseEvent mouseEvent) {
        editSupervisorSectionLabel.setVisible(false);
    }
    ...
    public void logOut(ActionEvent actionEvent) {
        ControllerRegistration.rootStage.close();
    ...
    public void serverPortMenuItem(ActionEvent actionEvent) {
        if (!tabPane.getTabs().contains(serverPortTab)) {
            tabPane.getTabs().add(serverPortTab);
        }
        int port = -1;
        try {
            Socket socket = new Socket(SBE.getServerHost(), SBE.getClientPort());
            DataInputStream in = new DataInputStream(new BufferedInputStream(socket.getInputStream()));
            DataOutputStream out = new DataOutputStream(new BufferedOutputStream(socket.getOutputStream()));
            out.writeUTF("00xxxserver");
            out.writeUTF("gx0server0port");
            out.flush();
            port = in.readInt();
            out.close();
            in.close();
        ...
        serverPortLabel.setText(new Integer(port).toString());

    }


    public void clientPortMenuItem(ActionEvent actionEvent) {
        if (!tabPane.getTabs().contains(clientPortTab)) {
            tabPane.getTabs().add(clientPortTab);
        }
        clientPortLabel.setText(new Integer(SBE.getClientPort()).toString());
    }

    public void dbUrlMenuItem(ActionEvent actionEvent) {
        if (!tabPane.getTabs().contains(dbUrlTab)) {
            tabPane.getTabs().add(dbUrlTab);
        }
        String url = null;
        try {
            Socket socket = new Socket(SBE.getServerHost(), SBE.getClientPort());
    ...
    public void dbUserMenuItem(ActionEvent actionEvent) {
        if (!tabPane.getTabs().contains(dbUserTab)) {
            tabPane.getTabs().add(dbUserTab);
        }
        String user = null;
        try {
            Socket socket = new Socket(SBE.getServerHost(), SBE.getClientPort());
    ...
    public void dbPasswordMenuItem(ActionEvent actionEvent) {
        if (!tabPane.getTabs().contains(dbPasswordTab)) {
            tabPane.getTabs().add(dbPasswordTab);
        }
        String pass = null;
        try {
            Socket socket = new Socket(SBE.getServerHost(), SBE.getClientPort());
        ...
        dbPasswordLabel.setText(pass);
    }

    public void serverHostMenuItem(ActionEvent actionEvent) {
        if (!tabPane.getTabs().contains(serverHostTab)) {
            tabPane.getTabs().add(serverHostTab);
        }
        serverHostLabel.setText(SBE.getServerHost());
    }

    public void serverPortEvent(ActionEvent actionEvent) {
    ...
    public void clientPortEvent(ActionEvent actionEvent) {
        if (!clientPortTxt.getText().isEmpty()) {
            int port = Integer.parseInt(clientPortTxt.getText());
            SBE.setClientPort(port);
            clientPortTxt.clear();
        }
    }

    public void dbUrlEvent(ActionEvent actionEvent) {
        if (!dbUrlTxt.getText().isEmpty()) {
            String url = dbUrlTxt.getText();
            try {
                Socket socket = new Socket(SBE.getServerHost(), SBE.getClientPort());
                DataInputStream in = new DataInputStream(new BufferedInputStream(socket.getInputStream()));
                DataOutputStream out = new DataOutputStream(new BufferedOutputStream(socket.getOutputStream()));
                out.writeUTF("00xxxserver");
                out.writeUTF("xx0db0url");
                out.writeUTF(url);
                out.flush();
                out.close();
                in.close();
    ...
    public void dbUserEvent(ActionEvent actionEvent) {
        if (!dbUserTxt.getText().isEmpty()) {
    ...
    public void dbPasswordEvent(ActionEvent actionEvent) {
        if (!dbPasswordTxt.getText().isEmpty()) {
            String pass = dbPasswordTxt.getText();
            try {
                Socket socket = new Socket(SBE.getServerHost(), SBE.getClientPort());
                DataInputStream in = new DataInputStream(new BufferedInputStream(socket.getInputStream()));
                DataOutputStream out = new DataOutputStream(new BufferedOutputStream(socket.getOutputStream()));
                out.writeUTF("00xxxserver");
                out.writeUTF("xx0db0password");
                out.writeUTF(pass);
                out.flush();
                out.close();
                in.close();
    ...
    public void serverHostEvent(ActionEvent actionEvent) {
        if (!serverHostTxt.getText().isEmpty()) {
            String host = serverHostTxt.getText();
            SBE.setServerHost(host);
            serverHostTxt.clear();
        }
    }
}
